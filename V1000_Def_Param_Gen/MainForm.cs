...
namespace V1000_Def_Param_Gen
{
    public partial class frmMain : Form
    {
        ...
        private void bwrkReadExcelFile_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            xlWorkbook = xlApp.Workbooks.Open("C:\\Users\\sferry\\source\\repos\\V1000_Def_Param_Gen\\V1000_Def_Param_Gen\\data\\Parameter List.xlsx");
        ...
        private void bwrk_ProgressComplete(object sender, RunWorkerCompletedEventArgs e)
        {
            switch (ProgressArgs.Mode_Sel)
            {
                ...
                case ProgressEventArgs.xlWriteMode: // Excel Write
                    ...
                    {
                        xlWorkbook.SaveAs("C:\\Users\\sferry\\source\\repos\\V1000_Def_Param_Gen\\V1000_Def_Param_Gen\\data\\Parameter Defaults.dat");
        ...
        {
            xlApp = new XL.Application();
            xlWorkbook = xlApp.Workbooks.Open("C:\\Users\\sferry\\source\\repos\\V1000_Def_Param_Gen\\V1000_Def_Param_Gen\\data\\Parameter Defaults.dat");
